...
{
    public partial class UpdateCentroTreinos : Form
    {
        private String toUpdate;
        private SqlConnection cn;
        public UpdateCentroTreinos(String toUpdate, SqlConnection cn)
        {
            InitializeComponent();
        ...
        private void labelInitialize()
        {
            if (!verifySGBDConnection())
                return;
            String commandText = "select nome FROM Clube.CentroTreinos WHERE id_centro_treinos=@id";
            ...
            label1.Text = "Actualização do Centro de Treinos " + nome + ", com o ID " + toUpdate + ":";
            reader.Close();
            cmd.Dispose();
            cn.Close();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(textBox1.Text))
                {
                    ...
                    cmd.CommandText = "UPDATE Clube.CentroTreinos SET  nome = @nome where id_centro_treinos = @id2";
                ...
                if (!string.IsNullOrEmpty(textBox2.Text))
                {
                    ...
                    cmd.CommandText = "UPDATE Clube.CentroTreinos SET  localizacao = @localizacao where id_centro_treinos = @id3";
                ...
                MessageBox.Show("Centro de Treinos Actualizado");
